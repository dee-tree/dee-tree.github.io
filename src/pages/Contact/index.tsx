      ...
      <section id='contact' className={styles.root}>
        ...
        <div className={styles.contactContainer}>
          ...
          <div className={styles.contactBlock}>
            ...
            <button className={styles.classicButton}><a target='_blank' rel='noopener noreferrer'
                                                        href='https://github.com/dee-tree'><h3>Github</h3></a>
            </button>
          </div>
        </div>

        <div className={styles.madeByBlock}>
          <p>made by <a target='_blank' rel='noopener noreferrer'
                        href='https://github.com/poletela-na-mars'>poletela-na-mars</a></p>
        </div>
      </section>
  );
};
